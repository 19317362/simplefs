...
void test_ywfpa_DevAdded_init() {
    ...
    EXPECT_EQ(dev_added.cmd_header.length, 0);
    EXPECT_EQ(dev_added.cmd_header.length_org, 0);
...
void test_ywfpa_DevAdded_values() {
    ...
    dev_added.cmd_header.length = 100;
    dev_added.cmd_header.length_org = 120;
    ...
    dump_buffer("test_ywfpa_DevAdded_values", buffer, stream.bytes_written);
    EXPECT_TRUE(status);
    ...
    EXPECT_EQ(dev_added2.cmd_header.length, 100);
    EXPECT_EQ(dev_added2.cmd_header.length_org, 120);
...
void test_ywfpa_DevRemoved_init() {
    ...
    EXPECT_EQ(dev_removed.cmd_header.length, 0);
    EXPECT_EQ(dev_removed.cmd_header.length_org, 0);
...
void test_ywfpa_DevRemoved_values() {
    ...
    dev_removed.cmd_header.length = 100;
    dev_removed.cmd_header.length_org = 120;
    ...
    EXPECT_EQ(dev_removed2.cmd_header.length, 100);
    EXPECT_EQ(dev_removed2.cmd_header.length_org, 120);
...
void test_ywfpa_SegmentUpdated_init() {
    ...
    EXPECT_EQ(segment_updated.cmd_header.length, 0);
    EXPECT_EQ(segment_updated.cmd_header.length_org, 0);
...
void test_ywfpa_SegmentUpdated_values() {
    ...
    EXPECT_EQ(segment_updated2.cmd_header.length, 100);
    EXPECT_EQ(segment_updated2.cmd_header.length_org, 120);
...
void test_ywfpa_PkgHeader_init() {
    ...
    EXPECT_EQ(pkg_header.length, 0);
    EXPECT_EQ(pkg_header.length_org, 0);
...
void test_ywfpa_PkgHeader_values() {
    ...
    pkg_header.length = 0x12345678;
    pkg_header.length_org = 0x87654321;
    ...
    EXPECT_EQ(pkg_header2.length, 0x12345678);
    EXPECT_EQ(pkg_header2.length_org, 0x87654321);
