...
void test_ywfpa_DevAdded_init() {
    ...
    EXPECT_FALSE(dev_added.cmd_header.has_pkg_header);
    EXPECT_EQ(dev_added.cmd_header.pkg_header.magic, 0);
    EXPECT_EQ(dev_added.cmd_header.pkg_header.cmd, 0);
    EXPECT_EQ(dev_added.cmd_header.pkg_header.length, 0);
    EXPECT_EQ(dev_added.cmd_header.pkg_header.length_org, 0);
...
void test_ywfpa_DevAdded_values() {
    ...
    EXPECT_TRUE(status);
    EXPECT_TRUE(dev_added2.has_cmd_header);
    EXPECT_TRUE(dev_added2.cmd_header.has_pkg_header);
    EXPECT_EQ(dev_added2.cmd_header.pkg_header.magic, 0xFEADBEEF);
    EXPECT_EQ(dev_added2.cmd_header.pkg_header.cmd, ywfpa_CmdId_CmdDevAdded);
    EXPECT_EQ(dev_added2.cmd_header.pkg_header.length, 100);
    EXPECT_EQ(dev_added2.cmd_header.pkg_header.length_org, 120);
    EXPECT_EQ(dev_added2.cmd_header.seq, 1);
    EXPECT_EQ(dev_added2.cmd_header.seq_org, 0);
    EXPECT_EQ(dev_added2.cmd_header.rc, 0);
    EXPECT_EQ(dev_added2.dev_id, 12345);
...
void test_ywfpa_DevRemoved_init() {
    ...
    EXPECT_FALSE(dev_removed.cmd_header.has_pkg_header);
    EXPECT_EQ(dev_removed.cmd_header.pkg_header.magic, 0);
    EXPECT_EQ(dev_removed.cmd_header.pkg_header.cmd, 0);
    EXPECT_EQ(dev_removed.cmd_header.pkg_header.length, 0);
    EXPECT_EQ(dev_removed.cmd_header.pkg_header.length_org, 0);
...
void test_ywfpa_DevRemoved_values() {
    ...
    EXPECT_TRUE(dev_removed2.cmd_header.has_pkg_header);
    EXPECT_EQ(dev_removed2.cmd_header.pkg_header.magic, 0xFEADBEEF);
    EXPECT_EQ(dev_removed2.cmd_header.pkg_header.cmd, ywfpa_CmdId_CmdDevRemoved);
    EXPECT_EQ(dev_removed2.cmd_header.pkg_header.length, 100);
    EXPECT_EQ(dev_removed2.cmd_header.pkg_header.length_org, 120);
...
void test_ywfpa_SegmentUpdated_init() {
    ...
    EXPECT_FALSE(segment_updated.cmd_header.has_pkg_header);
    EXPECT_EQ(segment_updated.cmd_header.pkg_header.magic, 0);
    EXPECT_EQ(segment_updated.cmd_header.pkg_header.cmd, 0);
    EXPECT_EQ(segment_updated.cmd_header.pkg_header.length, 0);
    EXPECT_EQ(segment_updated.cmd_header.pkg_header.length_org, 0);
...
void test_ywfpa_SegmentUpdated_values() {
    ...
    EXPECT_TRUE(segment_updated2.cmd_header.has_pkg_header);
    EXPECT_EQ(segment_updated2.cmd_header.pkg_header.magic, 0xFEADBEEF);
    EXPECT_EQ(segment_updated2.cmd_header.pkg_header.cmd, ywfpa_CmdId_CmdSegmentUpdated);
    EXPECT_EQ(segment_updated2.cmd_header.pkg_header.length, 100);
    EXPECT_EQ(segment_updated2.cmd_header.pkg_header.length_org, 120);
